...
public abstract class AbstractLazyPacketBoundRegistry<E extends ICodecProvider<E>,
    ...
    final void registerCommonWithPriority(EventPriority priority) {
        NeoForge.EVENT_BUS.addListener(priority, this::onAddReloadListeners);
    }
    ...
    @Override
    public final void handleProcess(IPayloadContext contextSupplier, ResourceLocation path, Supplier<E> item) {
